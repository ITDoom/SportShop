document.addEventListener("DOMContentLoaded",function(){
	...
	for (var i = 0; i < nut.length; i++) {
		...
		nut[i].onclick=function(){
			...
			if(this.classList[2]=='doimau'){ //click vao cai da hien thi roi
	...
	window.addEventListener('scroll',function(){ //bat su kien cuon chuot
		if(window.pageYOffset > 100){ //lay vi tri chuot cuon toi
